...
SWIGEXPORT void JNICALL Java_com_bandpowercalc_BandpowerCalcJNI_fft_1bandpower_1calculate(JNIEnv *jenv, jclass jcls, jdoubleArray jarg1, jdouble jarg2, jdoubleArray jarg3, jlong jarg4, jlong jarg5) {
  double *arg1 ;
  double arg2 ;
  double *arg3 ;
  ...
  (void)jenv;
  (void)jcls;
  if (jarg1 && (*jenv)->GetArrayLength(jenv, jarg1) != 256) {
  ...
  arg4 = *(double **)&jarg4; 
  arg5 = *(double **)&jarg5; 
  fft_bandpower_calculate((double const (*))arg1,arg2,arg3,arg4,arg5);
...
SWIGEXPORT jlong JNICALL Java_com_bandpowercalc_BandpowerCalcJNI_new_1doubleArray(JNIEnv *jenv, jclass jcls, jint jarg1) {
  jlong jresult = 0 ;
  int arg1 ;
  double *result = 0 ;
...
SWIGEXPORT void JNICALL Java_com_bandpowercalc_BandpowerCalcJNI_delete_1doubleArray(JNIEnv *jenv, jclass jcls, jlong jarg1) {
...
SWIGEXPORT jdouble JNICALL Java_com_bandpowercalc_BandpowerCalcJNI_doubleArray_1getitem(JNIEnv *jenv, jclass jcls, jlong jarg1, jint jarg2) {
  jdouble jresult = 0 ;
  double *arg1 = (double *) 0 ;
  int arg2 ;
  double result;
...
SWIGEXPORT void JNICALL Java_com_bandpowercalc_BandpowerCalcJNI_doubleArray_1setitem(JNIEnv *jenv, jclass jcls, jlong jarg1, jint jarg2, jdouble jarg3) {
  double *arg1 = (double *) 0 ;
  int arg2 ;
  double arg3 ;
