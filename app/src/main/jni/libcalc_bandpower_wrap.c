...
SWIGEXPORT void JNICALL Java_com_calcbandpower_CalcBandpowerJNI_calc_1bandpower(JNIEnv *jenv, jclass jcls, jdoubleArray jarg1, jdoubleArray jarg2, jdoubleArray jarg3) {
  double *arg1 ;
  double *arg2 ;
  double *arg3 ;
  jdouble *jarr1 ;
  ...
  if (jarg2 && (*jenv)->GetArrayLength(jenv, jarg2) != 257) {
    SWIG_JavaThrowException(jenv, SWIG_JavaIndexOutOfBoundsException, "incorrect array size");
    return ;
  }
  if (!SWIG_JavaArrayInDouble(jenv, &jarr2, (double **)&arg2, jarg2)) return ; 
  if (jarg3 && (*jenv)->GetArrayLength(jenv, jarg3) != 257) {
    SWIG_JavaThrowException(jenv, SWIG_JavaIndexOutOfBoundsException, "incorrect array size");
    return ;
  }
  if (!SWIG_JavaArrayInDouble(jenv, &jarr3, (double **)&arg3, jarg3)) return ; 
  calc_bandpower((double const (*))arg1,arg2,arg3);
...
SWIGEXPORT jlong JNICALL Java_com_calcbandpower_CalcBandpowerJNI_new_1doubleArray(JNIEnv *jenv, jclass jcls, jint jarg1) {
  jlong jresult = 0 ;
  int arg1 ;
  double *result = 0 ;
...
SWIGEXPORT void JNICALL Java_com_calcbandpower_CalcBandpowerJNI_delete_1doubleArray(JNIEnv *jenv, jclass jcls, jlong jarg1) {
...
SWIGEXPORT jdouble JNICALL Java_com_calcbandpower_CalcBandpowerJNI_doubleArray_1getitem(JNIEnv *jenv, jclass jcls, jlong jarg1, jint jarg2) {
  jdouble jresult = 0 ;
  double *arg1 = (double *) 0 ;
  int arg2 ;
  double result;
...
SWIGEXPORT void JNICALL Java_com_calcbandpower_CalcBandpowerJNI_doubleArray_1setitem(JNIEnv *jenv, jclass jcls, jlong jarg1, jint jarg2, jdouble jarg3) {
  double *arg1 = (double *) 0 ;
  int arg2 ;
  double arg3 ;
