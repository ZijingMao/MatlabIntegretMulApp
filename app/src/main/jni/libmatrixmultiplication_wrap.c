...
SWIGEXPORT void JNICALL Java_com_matrixmultiplication_MatrixMultiplicationJNI_matrix_1multiplication(JNIEnv *jenv, jclass jcls, jdoubleArray jarg1, jdoubleArray jarg2, jdoubleArray jarg3) {
  double *arg1 ;
  double *arg2 ;
  double *arg3 ;
  jdouble *jarr1 ;
  ...
  (void)jenv;
  (void)jcls;
  if (jarg1 && (*jenv)->GetArrayLength(jenv, jarg1) != 6) {
  ...
  matrix_multiplication((double const (*))arg1,(double const (*))arg2,arg3);
